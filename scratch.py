...
#         self.root_dir = Path(__file__).resolve().parents[2] / root_dir

#         if not self.root_dir.exists():
#             raise FileNotFoundError(f"Dataset not found: {self.root_dir}")

#         # Only load supported image files
#         self.image_paths = [
...
#             raise RuntimeError(f"No images found inside: {self.root_dir}")
...
#         # Placeholder label (update this for your project)
#         label = 0
